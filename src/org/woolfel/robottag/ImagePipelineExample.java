...
public class ImagePipelineExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //
        //
    	// NOTE: You will need to change the path to where you checked out the project
        File parentDir = new File("E:/deepLearning4J/github/dl4j-examples/dl4j-examples/src/main/resources/DataExamples/ImagePipeline");
